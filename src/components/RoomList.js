...
const rooms = [
  {
    ...
    description:
      "A community for dog lovers to share information, photos, experiences, and support each other.",
  },
...

  {
    ...
    description:
      "A community of people who have a passion for food and love to explore new culinary experiences.",
  },

  {
    ...
    description:
      "Those who love to read and immerse themselves in books, and often discuss and share their favorite stories with others",
  },

  {
    ...
    description:
      "A group of individuals who love to engage in outdoor activities such as hiking, camping, and rock climbing",
  },

  {
    ...
    description:
      " People who like to take on home improvement and craft projects, and enjoy working with their hands to create something new and unique",
  },

  {
    ...
    description:
      "Individuals who have a love for films and enjoy watching and discussing different genres, styles, and storylines.",
  },
];
